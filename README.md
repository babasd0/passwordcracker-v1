...
| `Main` | Point d'entrée : parsing des arguments et affichage des résultats |
 ...
 ## 4. Diagramme UML
   ...
   ![Diagramme de classes PasswordCracker](diagramme_uml_PasswordCracker.png)
...
```
**Vidéo de démonstration :** [Voir la vidéo de démonstration](https://youtu.be/lA8vnUFvdwg? si=g449BKmXMwAVn68I)
